...
* @{
*/
#define PRODUCT_KEY "a1f18e19fa44539d7c5f0bd6e26ac8"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "bb62050e0f155a811430e32599089b"
...
#define Temp_value_ADDITION                      0
#define Temp_value_MIN                           0
#define Temp_value_MAX                           99
#define Temp_value_LEN                           1
#define Humi_value_RATIO                         1
#define Humi_value_ADDITION                      0
#define Humi_value_MIN                           0
#define Humi_value_MAX                           99
#define Humi_value_LEN                           1
#define Smog_RATIO                         1
...
#define PM25_MAX                           500
#define PM25_LEN                           2
#define PM25_value_RATIO                         1
#define PM25_value_ADDITION                      0
#define PM25_value_MIN                           0
#define PM25_value_MAX                           500
#define PM25_value_LEN                           2
#define Smog_value_RATIO                         1
#define Smog_value_ADDITION                      0
#define Smog_value_MIN                           0
#define Smog_value_MAX                           500
#define Smog_value_LEN                           2
...
typedef struct {
    ...
    uint32_t valueTemp_value;
    uint32_t valueHumi_value;
    uint32_t valueSmog;
    uint32_t valuePM25;
    uint32_t valuePM25_value;
    uint32_t valueSmog_value;
} dataPoint_t;
...
typedef struct {
    ...
    uint8_t flagTemp_value:1;
    uint8_t flagHumi_value:1;
    uint8_t flagSmog:1;
    uint8_t flagPM25:1;
    uint8_t flagPM25_value:1;
    uint8_t flagSmog_value:1;
} dataPointFlags_t;
...
typedef struct {
    ...
    uint8_t valueHumi_value;
    uint16_t valueSmog;
    uint16_t valuePM25;
    uint16_t valuePM25_value;
    uint16_t valueSmog_value;
} devStatus_t;
