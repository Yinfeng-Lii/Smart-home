...
uint8_t aRxBuffer;
uint8_t ValueUpdateFlag;	//APP阈值数据更新标志位
...
int8_t gizwitsEventProcess(eventInfo_t *info, uint8_t *gizdata, uint32_t len)
{
    ...
    for(i=0; i<info->num; i++)
    {
        ...
        case EVENT_Temp_value:
            ...
            GIZWITS_LOG("Evt:EVENT_Temp_value %d\n",currentDataPoint.valueTemp_value);
            //user handle
			ValueUpdateFlag = 1;
			Temp_value = currentDataPoint.valueTemp_value;
            break;
        case EVENT_Humi_value:
            currentDataPoint.valueHumi_value = dataPointPtr->valueHumi_value;
            GIZWITS_LOG("Evt:EVENT_Humi_value %d\n",currentDataPoint.valueHumi_value);
            //user handle
			ValueUpdateFlag = 1;
			Humi_value = currentDataPoint.valueHumi_value;
            break;
        case EVENT_PM25_value:
            currentDataPoint.valuePM25_value = dataPointPtr->valuePM25_value;
            GIZWITS_LOG("Evt:EVENT_PM25_value %d\n",currentDataPoint.valuePM25_value);
            //user handle
			ValueUpdateFlag = 1;
			PM25_value = currentDataPoint.valuePM25_value;
            break;
        case EVENT_Smog_value:
            currentDataPoint.valueSmog_value = dataPointPtr->valueSmog_value;
            GIZWITS_LOG("Evt:EVENT_Smog_value %d\n",currentDataPoint.valueSmog_value);
            //user handle
			ValueUpdateFlag = 1;
			Smog_value = currentDataPoint.valueSmog_value;
            break;
...
void userHandle(void)
{
	...
	currentDataPoint.valueFan = Fan_Flag;
	currentDataPoint.valueHumidifier = Humidifier_Flag;
